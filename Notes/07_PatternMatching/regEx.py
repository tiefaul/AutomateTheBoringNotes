...
print(allnum.findall('Cell: 415-555-9999 Work: 123-456-7890')) # This can replace the search method and find every instance of what you want searched and add them to a list
